...
const togglecollapsible = (e, item) => {
    let temp = sessionStorage.getItem('seriesItems')
    temp = JSON.parse(temp)
    const _item = temp.find(i => i.text === item.text)
    item.collapsible = !!!item.collapsible;
    _item.collapsible = item.collapsible
    _item.collapsable = !item.collapsible
    sessionStorage.setItem('seriesItems', JSON.stringify(temp))
