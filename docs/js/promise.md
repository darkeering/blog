...
![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/1.png)

### \_Promise 2.0

接下来，我们在 excutor 中传入一个异步操作

![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/2.png)
...
![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/3.png)

### \_Promise 3.0

前面的都是基础，接下来的 then 的链式和值的穿透才是重点

![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/4.png) ![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/5.png)
...
执行之后的结果是正确的
![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/6.png)

但是，去掉 excutor 中的 settimeout 函数之后，结果和正统的 Promise 结果(1->2->success->11->22)不一样

![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/7.png)
...
执行看一下结果，确实实现了值的穿透
![img](https://cdn.jsdelivr.net/gh/darkeering/CDN@0.2/blog/promise/8.png)
